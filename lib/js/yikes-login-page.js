...
function delay_and_submit_form( e, submitted_form ) {
	...
	jQuery( '#yikes-custom-login-form, .yikes-custom-login-alert, #password-lost-form, #register-form, #password-reset-form, .forgot-password, .register-account' ).fadeTo( 'fast', 0.5 );
